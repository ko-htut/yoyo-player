...
class YoYoPlayerControlsConfiguration {
  ...
  final Widget Function(YoYoPlayerController controller)? customControlsBuilder;

  ///Parameter used to change theme of the player
  final YoYoPlayerTheme? playerTheme;
  ...
  final List<YoYoPlayerOverflowMenuItem> overflowMenuCustomItems;
  ...
  const YoYoPlayerControlsConfiguration(
  ...
  factory YoYoPlayerControlsConfiguration.white() {
    return const YoYoPlayerControlsConfiguration(
  ...
  factory YoYoPlayerControlsConfiguration.cupertino() {
    return const YoYoPlayerControlsConfiguration(
