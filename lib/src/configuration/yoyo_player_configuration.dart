...
class YoYoPlayerConfiguration {
  ...
  final YoYoPlayerRoutePageBuilder? routePageBuilder;

  /// Defines a event listener where video player events will be send
  final Function(YoYoPlayerEvent)? eventListener;

  ///Defines subtitles configuration
  final YoYoPlayerSubtitlesConfiguration subtitlesConfiguration;
  ...
  ///will be used.
  final List<YoYoPlayerTranslations>? translations;
  ...
  ///[YoYoPlayerController] on [YoYoPlayer] dispose. When it's true and
  ///[YoYoPlayerController] instance has been attached to [YoYoPlayer] widget
  ///and dispose has been called on [YoYoPlayer] instance, then
  ///[YoYoPlayerController] will be disposed.
  ///Default value is true.
  final bool autoDispose;

  const YoYoPlayerConfiguration({
    this.aspectRatio,
    this.autoPlay = false,
    this.startAt,
    this.looping = false,
    ...
    this.eventListener,
    this.subtitlesConfiguration = const YoYoPlayerSubtitlesConfiguration(),
    this.controlsConfiguration = const YoYoPlayerControlsConfiguration(),
  ...
  YoYoPlayerConfiguration copyWith({
    double? aspectRatio,
    bool? autoPlay,
    Duration? startAt,
    bool? looping,
    ...
    YoYoPlayerRoutePageBuilder? routePageBuilder,
    Function(YoYoPlayerEvent)? eventListener,
    YoYoPlayerSubtitlesConfiguration? subtitlesConfiguration,
    YoYoPlayerControlsConfiguration? controlsConfiguration,
    BoxFit? fit,
    double? rotation,
    Function(double visibilityFraction)? playerVisibilityChangedBehavior,
    List<YoYoPlayerTranslations>? translations,
    bool? autoDetectFullscreenDeviceOrientation,
  }) {
    return YoYoPlayerConfiguration(
