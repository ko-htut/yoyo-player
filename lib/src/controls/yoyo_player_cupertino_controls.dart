...
import 'yoyo_player_cupertino_progress_bar.dart';

class YoYoPlayerCupertinoControls extends StatefulWidget {
  ...
  const YoYoPlayerCupertinoControls({
  ...
  State<StatefulWidget> createState() {
    return _YoYoPlayerCupertinoControlsState();
  }
}

class _YoYoPlayerCupertinoControlsState
    extends YoYoPlayerControlsState<YoYoPlayerCupertinoControls> {
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              height: barHeight,
              color: backgroundColor,
              child: _yoyoPlayerController!.isLiveStream()
                  ? Row(
  ...
  Widget _buildPosition() {
    ...
    return Padding(
      ...
      child: Text(
        YoYoPlayerUtils.formatDuration(position),
        style: TextStyle(
  ...
  Widget _buildProgressBar() {
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.only(right: 12.0),
        child: YoYoPlayerCupertinoVideoProgressBar(
          _controller,
    ...
    setState(() {
      if (_controller!.value.isPlaying) {
        ...
        if (!_controller!.value.initialized) {
          if (_yoyoPlayerController!.yoyoPlayerDataSource?.liveStream == true) {
  ...
  Widget _buildPipButton(Color backgroundColor, Color iconColor,
    ...
    return FutureBuilder<bool>(
        future: _yoyoPlayerController!.isPictureInPictureSupported(),
        builder: (context, snapshot) {
          ...
          if (isPipSupported &&
            ...
            return GestureDetector(
              onTap: () {
                yoyoPlayerController!.enablePictureInPicture(
                    yoyoPlayerController!.yoyoPlayerGlobalKey!);
              },
              child: AnimatedOpacity(
                opacity: _hideStuff ? 0.0 : 1.0,
                duration: _controlsConfiguration.controlsHideTime,
