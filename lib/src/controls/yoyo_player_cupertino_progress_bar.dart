...
class YoYoPlayerCupertinoVideoProgressBar extends StatefulWidget {
  YoYoPlayerCupertinoVideoProgressBar(
    this.controller,
    this.yoyoPlayerController, {
    YoYoPlayerProgressColors? colors,
    this.onDragEnd,
    this.onDragStart,
    this.onDragUpdate,
    Key? key,
  })  : colors = colors ?? YoYoPlayerProgressColors(),
        super(key: key);

  final VideoPlayerController? controller;
  final YoYoPlayerController? yoyoPlayerController;
  final YoYoPlayerProgressColors colors;
...
class _VideoProgressBarState
    extends State<YoYoPlayerCupertinoVideoProgressBar> {
  ...
  YoYoPlayerController? get yoyoPlayerController => widget.yoyoPlayerController;
  ...
  Widget build(BuildContext context) {
    ...
    final bool enableProgressBarDrag = yoyoPlayerController!
        .yoyoPlayerConfiguration.controlsConfiguration.enableProgressBarDrag;
