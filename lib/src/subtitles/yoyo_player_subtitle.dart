...
class YoYoPlayerSubtitle {
  ...
  factory YoYoPlayerSubtitle(String value, bool isWebVTT) {
    try {
      ...
      YoYoPlayerUtils.log("Failed to parse subtitle line: $value");
      return YoYoPlayerSubtitle._();
    }
  }
  ...
  static YoYoPlayerSubtitle _handle3LinesAndMoreSubtitles(
  ...
  static Duration _stringToDuration(String value) {
    try {
      ...
      YoYoPlayerUtils.log("Failed to process value: $value");
      return const Duration();
    }
  }
}
